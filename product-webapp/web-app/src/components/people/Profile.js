...
function Profile() {
    ...
    const getUserData = () => {
        ...
        let url = "http://35.170.142.59:8080/user-service/api/v1/user/user/" + emailPass ;
    ...
    function fetchBookedSlot(data) {
        ...
        let url = "http://35.170.142.59:8080/slot-booking-service/api/v1/getByUserEmail/" + emailPass;
